...
class SearchForm(FlaskForm):
    ...
    fuel_type = SelectField("Fuel Type", choices=fuel_type_choices, validate_choice=True,\
         default="all", validators=[DataRequired()])
    distance_radius = SelectField("Distance", choices=distance_radius_choices, validate_choice=True,\
